...
class KPI {
    static async getAgileMetrics(projectId = '') {
        ...
        // 1. Lead Time Médio (dias entre criação e conclusão)
        ...
        // 2. Cycle Time Médio (dias entre início e conclusão)
        ...
        // 3. Velocity (Média de Story Points por Sprint Concluída)
        ...
        // 4. Throughput (Média de Tarefas Concluídas por Sprint)
        ...
        // 5. Sprint Success Rate (% de Sprints concluídas com sucesso)
        ...
        // 6. Task Completion Rate (% de Tarefas Concluídas)
        ...
        // 8. Burnup Data (Evolução de Escopo x Concluído por Sprint)
